"""
PyTorch TabNet Mock Module
Provides fallback for neural network tabular data model
"""
...
# Create module mock
class PyTorchTabNetModule:
    """Top-level pytorch_tabnet module mock"""
    
    def __init__(self):
        self.TabNetEncoder = TabNetEncoder
        self.TabNetRegressor = TabNetRegressor
        self.TabNetClassifier = TabNetClassifier


# Register in sys.modules
pytorch_tabnet_mock = PyTorchTabNetModule()
